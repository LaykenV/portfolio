...
import pbaPic1 from "../images/IWAI_screenshot1.png";
import pbaPic2 from "../images/IWAI_screenshot2.png";
...
function Projects (props) {
    ...
    return (
        <div className="projectsDiv" ref={props.refProp}>
            ...
            <div className="pokemonDiv">
                <img className="projectPhoto" src={sparq1} alt="ferrari"></img>
                <img className="projectPhoto" src={sparq2} alt="ferrari"></img>
                <div className="projectInfo">
